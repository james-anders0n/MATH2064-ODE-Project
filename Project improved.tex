...
\begin{figure}[H]
\centering
\begin{tikzpicture}[node distance=1.1cm, scale=1, every node/.style={scale=1}]
...
\begin{figure}[H]
\centering
\begin{tikzpicture}[node distance=1.15cm, scale=1, every node/.style={scale=1}]
...
\centering
\begin{tikzpicture}[node distance=1.2cm, scale=1, every node/.style={scale=0.8}]
...
Euler’s method requires one function evaluation per step, RK2 requires two evaluations, and RK4 requires four evaluations. Consequently, all methods have computational complexity $O(N)$, but with different constant factors. Higher-order methods therefore require more work per step, although they typically achieve the same accuracy with fewer time steps~\cite{20}.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\textwidth]{comparison_plot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\textwidth]{timing_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.67\textwidth]{error_vs_function_evaluations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{sir_stepsize_comparison.png}
